      ...
      <AccordionDetails>
        <form onSubmit={handleAddItemToCart}>
                        ...
                        <FormControlLabel
                          ...
                          control={
                            <Checkbox
                              ...
                              disabled={!ingredient.inStock} // Check if the ingredient is in stock
                            />
                          }
                          label={`${ingredient.name} ${
                            !ingredient.inStock ? "(Out of Stock)" : ""
                          }`} // Display "Out of Stock" for unavailable ingredients
                        />
                      )
                    )}
                  </FormGroup>
          ...
          <div className="pt-5">
            <Button
              variant="contained"
              disabled={!item.available} // Disable "Add to Cart" if the item is unavailable
              type="submit"
            >
              {item.available ? "Add to Cart" : "Out of Stock"}
            </Button>
