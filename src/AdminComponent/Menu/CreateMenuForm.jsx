...
import { createMenuItem } from "../../component/Sate/Menu/Action";
import { getIngredientsOfRestauarnt } from "../../component/Sate/Ingredients/Action";
...
const CreateMenuForm = () => {
    ...
    useEffect(()=>{
        dispatch(
            getIngredientsOfRestauarnt({jwt, id: restaurant.usersRestaurant.id})
        );
    },[]);
                        ...
                        <Grid item xs={12} lg={6}>
                            <FormControl fullWidth>
                                ...
                                <Select
                                    ...
                                    name="category"
                                >
                                    {restaurant.categories?.map((item)=><MenuItem value={item}>{item.name}
                                    </MenuItem>)}
